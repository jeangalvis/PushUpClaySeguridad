...
public class ProgramacionController : BaseApiController
{
    ...
    {
        var results = await _unitOfWork.Programacions
                                    .GetAllAsync();
    ...
    public async Task<ActionResult<Programacion>> Post(ProgramacionDto resultDto)
    {
        ...
        this._unitOfWork.Programacions.Add(result);
    ...
    {
        var result = await _unitOfWork.Programacions.GetAllAsync(resultParams.PageIndex, resultParams.PageSize, resultParams.Search);
